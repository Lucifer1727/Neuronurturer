    ...
    <div className="flex items-center justify-center w-screen h-screen p-6 bg-amber-400 bg-gradient-to-br from-amber-400 via-yellow-300 to-amber-400">
      ...
      >
        ...
        <p className="text-lg leading-relaxed font-medium text-white/90 max-w-2xl">
          We empower <span className="text-amber-300">parents, caregivers, and teachers</span> with training, resources, and one-on-one coaching.
          <br /><br />
          Backed by research <span className="italic text-white/70">(childrenscolorado.org)</span>, our strategies help children thrive in both home and school settings. Whether it’s using <span className="underline">visual supports</span> or <span className="underline">movement breaks</span>, we help caregivers nurture each child’s unique strengths with confidence and care.
        </p>
      </motion.div>
    </div>
  );
